...
<body>
    <div class="container">
        ...
        <form action="funcionarioAlterarSalvar.php" method="post" autocomplete="off">
            ...
            <input type="text" name="trabalho" id="trabalho" placeholder="Informe o ID do trabalho" required>
